...
**Version:** 1.3.0 (Canonical Unified Financial Edition)  
...
* **373% Net Direct ROI** in Year 1 with a payback period of **2.5 months**.
...
| :--- | :--- | :--- | :--- |
| **Baseline Raw HTML Prompt** | 1,870 tokens | $14.49 / year | 0% |
| **DOM AST Compression (65%)** | **650 tokens** | **$5.04 / year** | **65% Token Savings** |
| **0-Token Cache Hits (40% hits)** | **390 tokens** | **$3.02 / year** | **79% Token Savings** |

---

## 4. Total Cost of Ownership (TCO) Breakdown

* **Annual LLM API Token Cost**: **$5.04 / year** (2,800 runs @ $0.0018 per run).
* **Hosting & Infrastructure Allowance**: $1,200 / year (Docker / serverless host).
* **Engineering Maintenance**: $3,000 / year.
* **Total Annual OPEX**: **$4,205 / year**.

---

## 5. Financial Benefits & ROI Summary

* **Direct Labor Savings**: 234.0 hours saved $\times \$85/\text{hr} = \mathbf{\$19,890 / year}$.
* **Net Annual Direct Benefit**: $\$19,890 - \$4,205 = \mathbf{\$15,685 / year}$.
